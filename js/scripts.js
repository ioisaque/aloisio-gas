  ...
  * Copyright 2015 jQuery Foundation and other contributors; Licensed MIT */
  ...
  salvarPedido.on('click', function(e){
    ...
    $.ajax({
      ...
      success: function(data) {
        message.hide().removeClass('success').removeClass('error').addClass('error').html(data).fadeIn('slow').delay(5000).fadeOut('slow');
      }
    });
  });
...
//   '<li><a href="index.html" target="_blank"><img src="img/demos/ny.jpg" alt=""></a></li>' +
